...
CREATE TABLE `order_status_history` (
    ...
    `order_id` INTEGER NULL,
    `status` ENUM('pending', 'paid', 'shipped', 'completed', 'canceled') NULL,
...
CREATE TABLE `orders` (
    ...
    `status` ENUM('pending', 'paid', 'shipped', 'completed', 'canceled') NULL DEFAULT 'pending',
...
CREATE TABLE `payment` (
    ...
    `order_id` INTEGER NULL,
    `method` ENUM('cod', 'banking', 'momo', 'paypal') NULL,
