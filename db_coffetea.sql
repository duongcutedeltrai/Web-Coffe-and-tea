...
--
-- Host: localhost    Database: db_coffetea
-- ------------------------------------------------------
...
CREATE TABLE `order_status_history` (
  ...
  `order_id` int DEFAULT NULL,
  `status` enum('pending','paid','shipped','completed','canceled') DEFAULT NULL,
...
CREATE TABLE `payment` (
  ...
  `order_id` int DEFAULT NULL,
  `method` enum('cod','banking','momo','paypal') DEFAULT NULL,
...
CREATE TABLE `users` (
  ...
  `auth_provider` enum('system','google','facebook','apple') DEFAULT 'system',
  PRIMARY KEY (`user_id`),
...
-- Dump completed on 2025-09-05 16:11:25
