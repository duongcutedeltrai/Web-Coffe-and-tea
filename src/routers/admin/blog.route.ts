...
blogRoute.get("/blogs", authAndRoleMiddleware, adminStaffGuard, BlogController.getBlogPage);
blogRoute.get("/blogs/create", authAndRoleMiddleware, adminStaffGuard, BlogController.getBlogPage);
blogRoute.get("/blogs/:id", authAndRoleMiddleware, adminStaffGuard, BlogController.getBlogPage);
