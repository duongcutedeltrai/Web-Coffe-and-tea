...
productRoute.get("/products", authAndRoleMiddleware, adminStaffGuard, (req, res) => {
  res.render("admin/products/products.ejs");
});

productRoute.get("/products/:id", authAndRoleMiddleware, adminStaffGuard, AdminProductController.getDetailProductPage);
productRoute.put(
  "/products/:id",
